...
const ProfilePanel = ({ open, onClose }: ProfilePanelProps) => {
  ...
  return (
    <div className="absolute right-0 top-0 z-30 h-full w-72 overflow-y-auto border-l border-white/[0.07] bg-black/55 backdrop-blur-2xl p-7 animate-in slide-in-from-right duration-300">
      <button
        onClick={onClose}
      ...
      <div className="mt-8 mb-7">
        <div className="h-9 w-9 rounded-full border border-white/12 flex items-center justify-center mb-5">
          <span className="text-[12px] text-white/80 tracking-widest">T</span>
        </div>
      ...
      {/* About */}
      <p className="text-[13px] text-white/75 leading-relaxed mb-8">
        This galaxy maps the shape of a mind — channels collected on Are.na, distributed in space by
        semantic proximity. Each star is a thread of thought.
      </p>
